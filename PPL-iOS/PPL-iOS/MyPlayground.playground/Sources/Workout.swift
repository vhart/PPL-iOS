...
public struct  Workout {
    public let typeOfWorkout: TypeOfWorkout
...
extension Workout {
    internal mutating func createAlternatePullRoutine() {
        let barbellRow = Exercise(nameOfExercise: ExerciseName.barbellRow, weightOfExercise: 135.0, numberOfSets: 5, numberOfReps: 5, progressionScheme: .LowerBody)
