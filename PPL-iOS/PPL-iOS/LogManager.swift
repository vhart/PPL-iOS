...
struct LogManager {
    ...
    func returnPreviousWorkoutExercises(workoutLog: WorkoutLog) -> [Exercise]? {
        let typeOfWorkout = workoutLog.workout.typeOfWorkout
...
extension LogManager {
    private func returnPreviousPushExercises() -> [Exercise] {
    ...
    private func returnPreviousAlternatePushExercises() -> [Exercise] {
        var pushExercises = [Exercise]()
    ...
    private func returnPreviousPullExercises() -> [Exercise] {
    ...
    private func returnPreviousAlternatePullExercises() -> [Exercise] {
        var pullExercises = [Exercise]()
    ...
    private func returnPreviousWorkoutExercisesHelper(typeOfWorkout: TypeOfWorkout) -> [Exercise]? {
